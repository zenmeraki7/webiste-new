  ...
  return (
    <ThemeProvider theme={theme}>
      <Box sx={{ 
        ...
        {/* Apps Gallery with LIGHT background */}
        <Box 
          sx={{ 
            position: 'relative', 
                ...
                >
                  <Card 
                    sx={{ 
                      ...
                      transform: currentCardIndex === index ? 'scale(1.05)' : 'scale(1)',
                      zIndex: currentCardIndex === index ? 2 : 1,
                      position: 'relative',
                      opacity: currentCardIndex === index ? 1 : 0.85,
                      '&:hover': {
                        transform: 'scale(1.1) translateY(-15px)',
                        boxShadow: '0 30px 60px -12px rgba(10, 39, 37, 0.25), 0 18px 36px -18px rgba(0, 0, 0, 0.3)',
                        opacity: 1
                      }
                    }}
                  >
