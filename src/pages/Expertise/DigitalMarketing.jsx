...
function DigitalMarketing() {
  ...
  const features = [
    {
      icon: <FaChartLine />,
      title: "Targeted social media campaigns for maximum reach"
    },
    {
      icon: <RiSeoFill />,
      title: "SEO optimization to boost organic visibility"
    },
    {
      icon: <CgDatabase />,
      title: "Data-driven insights to refine marketing performance"
    }
  ];
        ...
        <div className="container">
          <div className="section-grid">
            <div className="content-column">
              ...
              <h2 className="section-title animate-on-scroll">Data-Driven Strategies for Maximum Impact</h2>
              <p className="section-description animate-on-scroll">
                Take your business to the next level with our result-driven digital marketing strategies:
              </p>
            ...
            <div className="visual-column animate-on-scroll">
              <div className="app-mockup">
                <div className="mockup-header">
                  ...
                  <div className="mockup-title">Marketing Dashboard</div>
                </div>
