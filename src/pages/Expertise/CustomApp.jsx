...
function CustomApp() {
  ...
  const features = [
    {
      icon: <FaHandshake />,
      title: "Cross-platform applications for maximum reach."
    },
    {
      icon: <TbAutomation />,
      title: "User-focused design and seamless functionality."
    },
    {
      icon: <MdOutlineApps />,
      title: "Agile development processes for timely delivery."
    }
  ];
        ...
        <div className="container">
          <div className="section-grid">
            <div className="content-column">
              ...
              <h2 className="section-title animate-on-scroll">Bespoke Apps for Seamless Business Growth.</h2>
