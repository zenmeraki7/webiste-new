...
import { MdManageAccounts, MdOutlineInventory, MdCampaign } from "react-icons/md";
  ...
  const features = [
    {
      ...
      title: "Comprehensive account setup and optimization"
    },
    {
    ...
    {
      icon: <MdCampaign />,
      title: "Strategic campaign management for growth and engagement"
    }
  ];
        ...
        <div className="container">
          <div className="section-grid">
            <div className="content-column">
              ...
              <h2 className="section-title animate-on-scroll">Effortless Management, Maximum Profitability</h2>
              <p className="section-description animate-on-scroll">
                We manage your e-commerce operations efficiently to maximize profits and streamline processes:
              </p>
            ...
            <div className="visual-column animate-on-scroll">
              <div className="app-mockup">
                <div className="mockup-header">
                  ...
                  <div className="mockup-title">E-commerce Dashboard</div>
                </div>
